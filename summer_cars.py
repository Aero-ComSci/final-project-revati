...
location=["San Fransico", "Los Angeles", "San Diego", "Redding"]
locationChoice=[]
...
def checklocation(selection1):
    selection1= selection1.lower()
    if selection1 in location:
        if selection1==location[0]:
            locationChoice.append("San Fransico")
            return "San Fransisco"
        if selection1==location[1]:
            locationChoice.append("Los Angeles")
            return "Los Angeles"
        if selection1==location[2]:
            locationChoice.append ("San Diego")
            return "San Diego"
        if selection1==location[3]:
            locationChoice.append("Redding")
            return "Redding"
        else:
            return 0
...
locationUserChoice=0 
locationUserChoice=checklocation(input("Here are the available locations for the car show, where would you like to go? San Fransicos, Los Angeles, San Diego, Redding"))
while locationChoice==None: 
    locationChoice=checklocation(input("Please pick a location from the given list"))
